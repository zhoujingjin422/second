...
date:2022/11/19
 */
class TodoAdapter3(val type:Int):BaseQuickAdapter<ContentBean, BaseDataBindingHolder<TodoItem3Binding>>(R.layout.todo_item_3) {
    override fun convert(holder: BaseDataBindingHolder<TodoItem3Binding>, item: ContentBean) {

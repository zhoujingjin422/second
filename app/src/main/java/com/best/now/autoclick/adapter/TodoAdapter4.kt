...
import com.best.now.autoclick.databinding.TodoItem3Binding
import com.best.now.autoclick.databinding.TodoItem4Binding
...
date:2022/11/19
 */
class TodoAdapter4(val type:Int):BaseQuickAdapter<ContentBean, BaseDataBindingHolder<TodoItem4Binding>>(R.layout.todo_item_4) {
    override fun convert(holder: BaseDataBindingHolder<TodoItem4Binding>, item: ContentBean) {

...
import com.best.now.seven.ui.MainnnActivity
import com.best.now.seven.ui.SubscribeeeActivity
...
fun isPurchased(context: AppCompatActivity? = null): Boolean {
    ...
    val purchased = MainnnActivity.purchased
    if (!purchased) {
        context?.startActivityForResult(Intent(context, SubscribeeeActivity::class.java), 100)
    }
    return purchased
}

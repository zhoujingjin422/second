...
import com.best.now.pdf.adapter.WeightAdapter
import com.best.now.pdf.bean.WeightBean
import com.best.now.pdf.databinding.ActivityWeightRecordBinding
import com.best.now.pdf.ext.getSpValue
import com.best.now.pdf.ext.putSpValue
import com.best.now.pdf.viewmodel.WeightRecordViewModel
...
date:2023/8/13
 */
class WeightRecordddActivity:BaseVMActivity() {
    ...
    override fun initView() {
        ...
        binding.apply {
            ...
            recyclerView.layoutManager = LinearLayoutManager(this@WeightRecordddActivity)
            ...
            tvDate.setOnClickListener {
                //日期选择
                val datePicker = DatePickerDialog(this@WeightRecordddActivity,{ _, year, month, day->

...
import com.best.now.pdf.databinding.ActivityProductBinding
import com.best.now.pdf.dialog.ChooseTypePop
import com.best.now.pdf.ext.getSpValue
import com.best.now.pdf.ext.putSpValue
import com.best.now.pdf.viewmodel.ProductViewModel
...
date:2023/8/13
 */
class ProductttActivity:BaseVMActivity() {
    ...
    override fun initView() {
        binding.apply {
            ...
            tvDate.setOnClickListener {
                //日期选择
                val datePicker = DatePickerDialog(this@ProductttActivity,{ _, year, month, day->
            ...
            tvDay.setOnClickListener {
                val pop = ChooseTypePop(this@ProductttActivity) {
                    type = it
                    tvDay.text = when (it) {
                        1 -> "Day"
                        2 -> "Month"
